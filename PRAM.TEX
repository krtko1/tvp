...
\begin{figure}[!ht]
 \centering
 \includegraphics{./OBRAZKY/PRAM/MODELRAM.EPS}
...
\begin{figure}[!ht]
 \centering
 \includegraphics{./OBRAZKY/PRAM/MODEPRAM.EPS}
...
\begin{figure}[!ht]
 \centering
 \includegraphics{./OBRAZKY/PRAM/MAXSTROM.EPS}
...
\begin{figure}[!ht]
\centering
\includegraphics{./OBRAZKY/PRAM/BOPRAM3.EPS}
...
\begin{figure}[!ht]
 \centering
 \includegraphics{./OBRAZKY/PRAM/BOPRAM1.EPS}
 \caption{Jeden krok simulácie $DTS$} \label{pram_obr_bopram1}
\end{figure}

\begin{figure}[!ht]
 \centering
 \includegraphics{./OBRAZKY/PRAM/BOPRAM2.EPS}
...
\begin{figure}[!ht]
 \centering
 \includegraphics{./OBRAZKY/PRAM/PRAMBO.EPS}
